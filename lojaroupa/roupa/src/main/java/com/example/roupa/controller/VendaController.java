...
public class VendaController {
    ...
    @GetMapping("/cliente")
    public ResponseEntity<Optional<List<Venda>>> findByCliente(@RequestParam String n){
        try {
    ...
    public ResponseEntity<Optional<List<Venda>>> findByFuncionario(@RequestParam String n){
        try {
    ...
    @GetMapping("/endereco")
    public ResponseEntity<Optional<List<Venda>>> findByMatricula(@RequestParam String ed){
        try {
    ...
    @GetMapping
    public ResponseEntity<Venda> findById(@RequestParam Long id)
    {
        try {
