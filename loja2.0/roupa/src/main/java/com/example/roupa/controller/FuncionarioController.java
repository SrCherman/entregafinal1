...
public class FuncionarioController {
    ...
    public ResponseEntity<Optional<List<Funcionario>>> findByNome(@RequestParam("nome") String n){
        try {
    ...
    public ResponseEntity<Optional<List<Funcionario>>> findByIdade(@RequestParam("idade") int i){
        try {
    ...
    public ResponseEntity<Optional<List<Funcionario>>> findByMatricula(@RequestParam("matricula") String m){
        try {
