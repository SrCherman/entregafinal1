...
public class ProdutoController {
    ...
    public ResponseEntity<Optional<List<Produto>>> findByNome(@RequestParam("nome") String n){
        try {
    ...
    public ResponseEntity<Optional<List<Produto>>> findByValor(@RequestParam("valor") float v){
        try {
